...
export default function QuizApp({ selectedQuiz, onData }) {
  ...
  const quizData = selectedQuiz.questions;
  const current = quizData.filter(q => quizData.indexOf(q) === currentQuestion);
        ...
        return (
          <div key={q.id} className="flex flex-col items-center py-6">
            ...
            <div className="w-full max-w-2xl mb-8">
              <ProgressBar
                current={numQuestion}
                percate={parseInt((numQuestion * 100) / quizData.length)}
