        ...
        <div className="min-h-screen bg-gradient-to-br from-blue-50 to-indigo-100 py-8 px-4">
            <div className="max-w-4xl mx-auto">
                ...
                <div className="bg-white rounded-2xl shadow-xl p-8 mb-8 text-center">
                    ...
                    <div className={`inline-block px-6 py-2 rounded-full text-white font-medium ${percentage >= 70 ? 'bg-green-500' :
                ...
                <div className="space-y-6">
                    {responses.map((q, index) => {
                        ...
                        return (
                            <div key={q.id} className={`bg-white rounded-xl shadow-lg overflow-hidden border-l-4 ${isCorrect ? 'border-green-500' : 'border-red-500'
                                }`}>
                                <div className="p-6">
                                    {/* En-tête question */}
                                    <div className="flex items-center justify-between mb-4">
                                        ...
                                        <div className={`px-3 py-1 rounded-full text-sm font-medium ${isCorrect ? 'bg-green-100 text-green-800' : 'bg-red-100 text-red-800'
                                            }`}>
